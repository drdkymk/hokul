...
function CalisanAktivitePage() {
  ...
  useEffect(() => {
    Axios.get("http://localhost:3001/api/CalisanProblem/BirimID/" + getCurrentUser().department)
      .then((response) => {
  ...
  return (
    <div className="App">
      <Row>
        ...
        <Col><h3> Çalışan Aktiviteleri </h3></Col>
        <Col>
...
export default CalisanAktivitePage;
